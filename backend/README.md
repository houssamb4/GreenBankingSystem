...
1. **Define Entity** (if needed) in `entity/`
2. **Create Repository** in `repository/`
3. **Implement Service** in `service/`
4. **Add GraphQL Resolver** in `resolver/`
5. **Update Schema** in `resources/graphql/`
...
- Check [GRAPHQL_API.md](GRAPHQL_API.md) for API documentation
- Review [../database/EXISTING_DB_SETUP.md](../database/EXISTING_DB_SETUP.md) for database setup
- See project root README for overall architecture

## 🔗 Related Documentation

- [Frontend README](../frontend/README.md) - Flutter mobile app
- [GraphQL API Documentation](GRAPHQL_API.md) - Complete API reference
