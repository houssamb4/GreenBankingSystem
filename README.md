...
- [x] Core carbon calculation engine
- [x] 14 transaction categories
- [x] GraphQL API
...
- **Backend Issues**: Check [backend/GRAPHQL_API.md](backend/GRAPHQL_API.md)
...
- 📊 **Visualize** their carbon footprint
- 🎯 **Set goals** with monthly budgets
- 📉 **Reduce emissions** through informed decisions
- 🏆 **Compete** with eco scores

**Example**: User reducing spending from high-carbon categories (Travel, Transport) to low-carbon (Green, Education) can reduce their monthly footprint by up to 90%!
